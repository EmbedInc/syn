...
typedef sys_int_machine_t array_1_t[1];
...
typedef fline_coll_t *fline_coll_p_t;
...
typedef fline_virtlin_t *fline_virtlin_p_t;
...
extern __declspec(dllexport) unsigned char __stdcall syn_chsyn_item (
  syn_t *);
