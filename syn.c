...
typedef string_hash_t *string_hash_p_t;
...
extern __declspec(dllexport) unsigned char __stdcall syn_chsyn_space (
  syn_t *);
...
extern __declspec(dllexport) unsigned char __stdcall syn_chsyn_pad (
  syn_t *);
